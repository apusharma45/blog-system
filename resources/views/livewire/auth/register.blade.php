...
new #[Layout('components.layouts.auth')] class extends Component {
    ...
    public function register(): void
    {
        ...
        // Force full page redirect without Livewire navigation
...
<div class="flex flex-col gap-6">
    ...
    <div class="space-y-2">
        ...
        <p class="text-sm text-zinc-600 dark:text-zinc-400">
            Join our professional publishing platform
        </p>
    </div>
    ...
    <form method="POST" wire:submit="register" class="flex flex-col gap-5">
        ...
        <!-- Terms Notice -->
        <div class="p-3 bg-zinc-50 dark:bg-zinc-900/50 rounded-md border border-zinc-200 dark:border-zinc-800">
            <p class="text-xs text-zinc-600 dark:text-zinc-400">
                By creating an account, you agree to our 
                <a href="#" class="text-zinc-900 dark:text-white hover:underline">Terms of Service</a> 
                and 
                <a href="#" class="text-zinc-900 dark:text-white hover:underline">Privacy Policy</a>.
            </p>
        </div>
    ...
    <div class="text-center pt-3 border-t border-zinc-200 dark:border-zinc-800">
        <span class="text-sm text-zinc-600 dark:text-zinc-400">{{ __("Already have an account?") }}</span>
        <flux:link 
            :href="route('login')" 
            wire:navigate
