<x-layouts.homepage :title="__('Edit Post')">
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 dark:from-slate-950 dark:via-blue-950/30 dark:to-indigo-950/20">
    <div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="bg-gradient-to-r from-white via-blue-50/50 to-indigo-50/30 dark:from-slate-900 dark:via-blue-900/20 dark:to-indigo-900/20 border-b border-zinc-200 dark:border-zinc-800 mb-8">
            <div class="flex items-center space-x-4 py-6">
                ...
                <div>
                    <h1 class="text-3xl sm:text-4xl font-semibold bg-gradient-to-r from-blue-900 via-indigo-800 to-purple-800 dark:from-blue-200 dark:via-indigo-200 dark:to-purple-200 bg-clip-text text-transparent">Edit Post</h1>
                    <p class="text-lg sm:text-xl text-zinc-600 dark:text-zinc-400 mt-1">Update your post content and settings</p>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('posts.update', $post) }}" enctype="multipart/form-data" class="space-y-8">
            ...
            <!-- Title -->
            <div class="bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/20 rounded-2xl dark:from-slate-900 dark:via-blue-900/20 dark:to-indigo-900/20 border border-zinc-200 dark:border-zinc-800 p-6 transition-all duration-300 shadow-xl hover:shadow-2xl">
            ...
            <!-- Content -->
            <div class="bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/20 rounded-2xl dark:from-slate-900 dark:via-blue-900/20 dark:to-indigo-900/20 border border-zinc-200 dark:border-zinc-800 p-6 transition-all duration-300 shadow-xl hover:shadow-2xl">
                <label for="content" class="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-3">
                    <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/20 rounded-2xl dark:from-slate-900 dark:via-blue-900/20 dark:to-indigo-900/20 border border-zinc-200 dark:border-zinc-800 p-6 transition-all duration-300 shadow-xl hover:shadow-2xl">
                ...
                <div class="space-y-4">
                    <div class="relative">
                        ...
                        >
                        <label for="featured_image" class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, GIF, WEBP (MAX. 5MB)</p>
                            </div>
                        </label>
                    </div>
                    ...
                    <div id="new-image-preview" class="hidden">
                        <div class="relative inline-block">
                            <img id="preview-new-img" src="" alt="Preview" class="w-48 h-32 object-cover rounded-lg border border-gray-300 dark:border-gray-600">
                            <button type="button" onclick="removeNewImage()" class="absolute top-2 right-2 bg-red-500 text-white rounded-full p-1 hover:bg-red-600 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                </svg>
                            </button>
                        </div>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">New image preview</p>
                    </div>
                    
                    <div class="text-xs text-gray-500 dark:text-gray-400">
                        💡 <strong>Tip:</strong> {{ $post->featured_image ? 'Upload a new image to replace the current one' : 'A featured image helps your post stand out in the feed' }}
                    </div>
                </div>
            ...
            <!-- Status -->
            <div class="bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/20 rounded-2xl dark:from-slate-900 dark:via-blue-900/20 dark:to-indigo-900/20 border border-zinc-200 dark:border-zinc-800 p-6 transition-all duration-300 shadow-xl hover:shadow-2xl">
                <label for="status" class="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-3">
                    <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/20 rounded-2xl dark:from-slate-900 dark:via-blue-900/20 dark:to-indigo-900/20 border border-zinc-200 dark:border-zinc-800 p-6 transition-all duration-300 shadow-xl hover:shadow-2xl">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('posts.show', ['username' => $post->user->username, 'slug' => $post->slug]) }}" class="text-zinc-600 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-200 transition-colors">View Post</a>
                        <a href="{{ route('dashboard', ['username' => auth()->user()->username]) }}" class="text-zinc-600 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-200 transition-colors">Cancel</a>
                    </div>
                    <div class="flex items-center space-x-4">
                        <button 
                            type="submit" 
